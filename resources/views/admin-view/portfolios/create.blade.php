...
<head>
    ...
    <title>Create Portfolio - Dashboard</title>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <button type="submit" id="submit-btn" class="btn btn-primary">
                                            <span id="submit-text">Create Portfolio</span>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#portfolio-form').on('submit', async function(e) {
                ...
                try {
                    const response = await fetch('{{ route("admin.portfolios.store") }}', {
                        method: 'POST',
                        headers: {
                    ...
                    if (response.ok && data.success) {
                        ...
                        if (data.errors) {
                            ...
                            showAlert(data.message || 'An error occurred while creating the portfolio.', 'error');
                        }
                    }
                } catch (error) {
                    ...
                    $('#submit-text').text('Create Portfolio');
