...
<body id="page-top">
    ...
    <!-- Page level plugins -->
    <script src="{{ asset('admin-view/vendor/chart.js/Chart.min.js') }}"></script>

    <!-- Page level custom scripts -->
    <script src="{{ asset('admin-view/js/demo/chart-area-demo.js') }}"></script>
    <script src="{{ asset('admin-view/js/demo/chart-pie-demo.js') }}"></script>
